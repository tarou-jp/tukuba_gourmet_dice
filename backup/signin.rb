...
<div class="overlay"></div>
    ...
    <div class="signin-page">
        <div class="form">
            <h1>新規登録</h1>
            <form class="signin-form"  id="signinForm" method="post" action="https://cgi.u.tsukuba.ac.jp/~s2210573/local_only/wp/signin_check.rb">
                ...
                <p class="message">アカウントを既に登録済みの方<a href="https://cgi.u.tsukuba.ac.jp/~s2210573/local_only/wp/login.rb">Login</a></p>
            </form>
        </div>
    </div>
</body>
